...
## Microsoft Azure
   Microsoft Azure มีบริการที่หลากหลายพร้อมให้เลือกใช้งานตามความเหมาะสมกับลักษณะงานที่ต้องการทำ ทั้งยังมาพร้อมกับระบบการรักษาความปลอดภัย ซึ่งนับว่าเป็นเรื่องสำคัญที่สุดของการทำงานบนระบบ Cloud  ไม่ว่าจะเป็นระบบการตรวจสอบและยืนยันตัวตนของผู้ใช้งาน ระบบการเข้ารหัสในการรับส่งข้อมูล (Encryption) และระบบการตรวจสอบการเข้าใช้งาน เป็นต้น นอกจากนี้ Microsoft Azure ยังออกแบบบริการมาเพื่อให้ง่ายต่อการใช้งานโดยเฉพาะงานด้าน Big Data ทำให้บริการมีความครอบคุลมการทำงานที่เอื้อให้ Data Scientist และ Developer ทำงานได้ง่ายขึ้นและมีความหลากหลายในการเลือกใช้โปรแกรม 
   Microsoft Azure มีสถาปัตยกรรมที่สามารถรองรับข้อมูลขนาดใหญ่และได้รับการออกแบบเพื่อจัดการ การประมวลผลและการวิเคราะห์ข้อมูลที่มีความซับซ้อนสำหรับระบบฐานข้อมูลหลายรูปแบบทั้งที่เป็น Structured และ Unstructured ทั้งนี้ Azure ยังช่วยให้ผู้ใช้งานทั่วไปที่อาจไม่มีความเชี่ยวชาญในการเขียนโปรแกรมสามารถเข้าใช้งานได้ผ่าน Graphical User Interface (GUI) ซึ่งมีความคล้ายคลึงกับ Microsoft Office ที่ใช้งานกันอยู่ในปัจจุบัน ทาง Microsoft Azure ได้ทำการออกแบบ Infrastructure สำหรับงานด้าน Big Data Analytics ดังแสดงในรูปภาพ 1ซึ่งแสดงโซลูชันบิกเดต้าของโปรเจ็กนี้จะเกี่ยวข้องกับประเภทงานต่อไปนี้:
- การประมวลผลแบทช์แหล่งข้อมูลขนาดใหญ่
